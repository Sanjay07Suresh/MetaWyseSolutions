...
## Generated on : Tue Dec 10 10:43:08 2024
...
DEFINES_STANDARD = -DMODEL=generate_c_code -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/generate_c_code_ert_rtw/generate_c_code.c

MAIN_SRC = $(START_DIR)/generate_c_code_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/generate_c_code_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/generate_c_code_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/generate_c_code_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/generate_c_code_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/generate_c_code_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.obj : $(START_DIR)/generate_c_code_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


generate_c_code.obj : $(START_DIR)/generate_c_code_ert_rtw/generate_c_code.c
	$(CC) $(CFLAGS) -o "$@" "$<"
